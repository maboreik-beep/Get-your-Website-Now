...
import WebsiteComponent from './WebsiteComponent'; // FIX: Changed to default import
...
export const EditorView: React.FC<{ onExit: () => void; onSave: () => Promise<string>; }> = ({ onExit, onSave }) => {
    ...
    return (
        <div className="flex h-screen bg-dark-bg">
            ...
            <div className={`flex-1 flex flex-col h-screen overflow-y-auto relative ${showEditorPanel ? 'md:w-[calc(100%-320px)] lg:w-[calc(100%-384px)]' : 'w-full'} min-w-0`}> {/* Added min-w-0 for mobile responsiveness */}
