...
export const GOONLINE_LOGO_BASE64 = `data:image/svg+xml;base64,`;
...
export const ICONS = {
  ...
  // Corrected icon definitions for Message, Trash, Mic, MicOff, Geo, Send, Plus, Bars3, XMark, Eye, Pencil, ArrowUp, ArrowDown
...
const UI_TRANSLATIONS: { [langCode: string]: UITranslations } = {
  en: {
    ...
    'errorWebsiteGenerationFailed': 'Website generation failed. This might be due to a complex request, network issues, or an API error. Please try again or simplify your request.',
...
const createFooterSection = (companyName: Record<string, string>, theme: 'light' | 'dark', index: number = 0, defaultLang: string, t: (key: string, variables?: Record<string, string>) => string): FooterSection => ({
    ...
    type: 'Footer',
    enabled: true,
    // FIX: Explicitly assert the type of the multilingual object to resolve potential type inference issues.
    text: { [defaultLang]: `© ${new Date().getFullYear()} ${companyName[defaultLang]}. ${t('allRightsReserved')}` } as Record<string, string>,
    socialLinks: {
        twitter: '#',
        linkedin: '#',
        facebook: '#',
